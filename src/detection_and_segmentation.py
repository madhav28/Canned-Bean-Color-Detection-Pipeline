...
def detection_and_segmentation():
    ...
    for img in tqdm(img_path, desc="⏳ Detecting and Segmenting Beans"):
        write_path1 = img.replace("input/images", "output/detection")
        write_path2 = img.replace("input/images", "output/segmentation")
        ...
        for box in boxes:
            ...
            cv2.rectangle(image_with_boxes, (x1, y1), (x2, y2), (0, 0, 255), 10)  
        cv2.imwrite(write_path1, image_with_boxes)
